    ...
    function StaticTreeRenderer(args) {
        ...
        this.setSelected = function(ids, mode) {
            ...
            ids.forEach(function(id) {        
                ...
                self.openParentNode(domNodes[id]);
        ...
        this.closeAndOpen=function(e,label){
            //console.log(e,label,$(e.target).next());
            $(e.target).next().toggle();
            
        };

        this.openParentNode=function(div){
            var $d=$(div);
            $d.parents(".children").show();
        };
        var models = [];
