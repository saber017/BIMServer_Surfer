...
//    		console.log("Clearing visible ranges cache", this.visibleRanges.size);
		...
		//console.info('ids_with_or_without---'+Object.keys(ids_with_or_without));
		//console.info('ids_with_or_without.nonce---'+ids_with_or_without.without.nonce);
		//console.info('ids---'+ids);
		//console.info('ids.nonce---'+ids.nonce);
