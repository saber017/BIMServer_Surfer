            ...
            case 1:
            	if (dt < 500. && this.closeEnoughCanvas(this.mouseDownPos, this.mousePos)) {
                    ...
                    if (viewObject && viewObject.object) {
                        ...
                        //页面上显示选中构件信息
                        domtree.setSelected([lastRevisionId+":"+viewObject.object.uniqueId], domtree.SELECT_EXCLUSIVE);
                        metadata.beSelected([lastRevisionId+":"+viewObject.object.uniqueId]);                      
                        //console.log("object",viewObject);
                    }
